      ...
      <ModalContent>
        {() => (
          <>
            ...
            <ModalBody>
              <div className="container flex flex-col space-y-3 overflow-auto bg-white pb-10">
                <p className="mt-5 mx-auto max-w-prose text-gray-500">
                  Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen.
                  Eine Nutzung der Internetseiten der{" "}
                  {companyInformation.colophon.companyName} ist grundsätzlich
                ...
                <p className="mt-5 mx-auto max-w-prose text-gray-500">
                  ...
                  die {companyInformation.colophon.companyName} geltenden
                ...
                <p className="mt-5 mx-auto max-w-prose text-gray-500">
                  Die {companyInformation.colophon.companyName} hat als für die
                ...
                <h4 className="mt-5 mx-auto max-w-prose text-xl font-extrabold text-gray-900">
                  1. Begriffsbestimmungen
                </h4>
                <p className="mt-5 mx-auto max-w-prose text-gray-500">
                  Die Datenschutzerklärung der{" "}
                  {companyInformation.colophon.companyName}
                  ...
                  Datenschutzerklärung soll sowohl für die Öffentlichkeit als
                ...
                <ul className="list-none">
                  <li className="mt-2 mx-auto max-w-prose text-gray-500">
                    <h4 className="mt-5 mx-auto max-w-prose text-xl font-extrabold text-gray-900">
                ...
                <p className="mx-auto max-w-prose text-gray-500">
                  {companyInformation.colophon.location.streetName}{" "}
                  {companyInformation.colophon.location.streetNumber}
                </p>
                <p className="mx-auto max-w-prose text-gray-500">
                  {companyInformation.colophon.location.postalCode}{" "}
                  {companyInformation.colophon.location.city}
                </p>
                <p className="mx-auto max-w-prose text-gray-500">
                  {companyInformation.colophon.location.country}
                </p>
                <p className="mx-auto max-w-prose text-gray-500">
                  Tel.: {companyInformation.colophon.telephone}
                </p>
                <p className="mx-auto max-w-prose text-gray-500">
                  E-Mail: {companyInformation.colophon.email}
                </p>
                ...
                <p className="mt-5 mx-auto max-w-prose text-gray-500">
                  ...
                  betroffene Person oder ein automatisiertes System eine Reihe
                  von allgemeinen Daten und Informationen. Diese allgemeinen
                  ...
                  Internetseite, (6) eine Internet-Protokoll-Adresse
                  (IP-Adresse), (7) der Internet-Service-Provider des
                  zugreifenden Systems und (8) sonstige ähnliche Daten und
                  Informationen, die der Gefahrenabwehr im Falle von Angriffen
                  auf unsere informationstechnologischen Systeme dienen.
                </p>

                <p className="mt-5 mx-auto max-w-prose text-gray-500">
                  Bei der Nutzung dieser allgemeinen Daten und Informationen
                  zieht die {companyInformation.colophon.companyName} keine
                  Rückschlüsse auf die betroffene Person. Diese Informationen
                  werden vielmehr benötigt, um (1) die Inhalte unserer
                  Internetseite korrekt auszuliefern, (2) die Inhalte unserer
                  Internetseite sowie die Werbung für diese zu optimieren, (3)
                  ...
                  die {companyInformation.colophon.companyName} daher einerseits
                  ...
                  anonymen Daten der Server-Logfiles werden getrennt von allen
                  durch eine betroffene Person angegebenen personenbezogenen
                  Daten gespeichert.
                </p>
                ...
                <ul className="list-none">
                  <li className="mt-2 mx-auto max-w-prose text-gray-500">
                    ...
                    <p className="mt-5 mx-auto max-w-prose text-gray-500">
                      ...
                      dem für die Verarbeitung Verantwortlichen eine Bestätigung
                      darüber zu verlangen, ob sie betreffende personenbezogene
                      Daten verarbeitet werden. Möchte eine betroffene Person
                      dieses Bestätigungsrecht in Anspruch nehmen, kann sie sich
                  ...
                  <li className="mt-2 mx-auto max-w-prose text-gray-500">
                    ...
                    <p className="mt-5 mx-auto max-w-prose text-gray-500">
                      ...
                      und Verordnungsgeber gewährte Recht, jederzeit von dem für
                      die Verarbeitung Verantwortlichen unentgeltliche Auskunft
                      über die zu seiner Person gespeicherten personenbezogenen
                      Daten und eine Kopie dieser Auskunft zu erhalten. Ferner
                      hat der Europäische Richtlinien- und Verordnungsgeber der
                    ...
                    <ul className="list-none">
                      ...
                      <li className="mt-2 mx-auto max-w-prose text-gray-500">
                        ...
                        DS-GVO und — zumindest in diesen Fällen —
                  ...
                  <li className="mt-2 mx-auto max-w-prose text-gray-500">
                    ...
                    <ul className="list-none">
                      ...
                      <li className="mt-2 mx-auto max-w-prose text-gray-500">
                        ...
                        Art. 21 Abs. 2 DS-GVO Widerspruch gegen die Verarbeitung
                        ein.
                      </li>
                      <li className="mt-2 mx-auto max-w-prose text-gray-500">
                    ...
                    <p className="mt-5 mx-auto max-w-prose text-gray-500">
                      ...
                      Daten, die bei der{" "}
                      {companyInformation.colophon.companyName} gespeichert
                      sind, veranlassen möchte, kann sie sich hierzu jederzeit
                      an einen Mitarbeiter des für die Verarbeitung
                      Verantwortlichen wenden. Der Mitarbeiter der{" "}
                      {companyInformation.colophon.companyName} wird
                    ...
                    <p className="mt-5 mx-auto max-w-prose text-gray-500">
                      ...
                      personenbezogenen Daten verarbeiten, darüber in Kenntnis
                      zu setzen, dass die betroffene Person von diesen anderen
                      für die Datenverarbeitung Verantwortlichen die Löschung
                      sämtlicher Links zu diesen personenbezogenen Daten oder
                      von Kopien oder Replikationen dieser personenbezogenen
                      Daten verlangt hat, soweit die Verarbeitung nicht
                      erforderlich ist. Der Mitarbeiter der{" "}
                      {companyInformation.colophon.companyName} wird im
                  ...
                  <li className="mt-2 mx-auto max-w-prose text-gray-500">
                    ...
                    <p className="mt-5 mx-auto max-w-prose text-gray-500">
                      ...
                      {companyInformation.colophon.companyName} gespeichert
                      sind, verlangen möchte, kann sie sich hierzu jederzeit an
                      einen Mitarbeiter des für die Verarbeitung
                      Verantwortlichen wenden. Der Mitarbeiter der{" "}
                      {companyInformation.colophon.companyName} wird die
                  ...
                  <li className="mt-2 mx-auto max-w-prose text-gray-500">
                    ...
                    <p className="mt-5 mx-auto max-w-prose text-gray-500">
                      ...
                      DS-GVO das Recht, zu erwirken, dass die personenbezogenen
                    ...
                    <p className="mt-5 mx-auto max-w-prose text-gray-500">
                      ...
                      Mitarbeiter der {companyInformation.colophon.companyName}{" "}
                      wenden.
                    </p>
                  </li>
                  <li className="mt-2 mx-auto max-w-prose text-gray-500">
                    ...
                    <p className="mt-5 mx-auto max-w-prose text-gray-500">
                      ...
                      die aufgrund von Art. 6 Abs. 1 Buchstaben e oder f DS-GVO
                      erfolgt, Widerspruch einzulegen. Dies gilt auch für ein
                      auf diese Bestimmungen gestütztes Profiling.
                    </p>

                    <p className="mt-5 mx-auto max-w-prose text-gray-500">
                      Die {companyInformation.colophon.companyName}
                    ...
                    <p className="mt-5 mx-auto max-w-prose text-gray-500">
                      Verarbeitet die {companyInformation.colophon.companyName}
                      ...
                      {companyInformation.colophon.companyName} die
                    ...
                    <p className="mt-5 mx-auto max-w-prose text-gray-500">
                      ...
                      sie betreffende Verarbeitung personenbezogener Daten, die
                      bei der {companyInformation.colophon.companyName}
                    ...
                    <p className="mt-5 mx-auto max-w-prose text-gray-500">
                      ...
                      Person steht es ferner frei, im Zusammenhang mit der
                  ...
                  <li className="mt-2 mx-auto max-w-prose text-gray-500">
                    ...
                    <p className="mt-5 mx-auto max-w-prose text-gray-500">
                      ...
                      ist, oder (2) aufgrund von Rechtsvorschriften der Union
                    ...
                    <p className="mt-5 mx-auto max-w-prose text-gray-500">
                      ...
                      und dem Verantwortlichen erforderlich oder (2) erfolgt sie
                      mit ausdrücklicher Einwilligung der betroffenen Person,
                      trifft die {companyInformation.colophon.companyName}{" "}
                      angemessene Maßnahmen, um die Rechte und Freiheiten sowie
                      die berechtigten Interessen der betroffenen Person zu
                ...
                <p className="mt-5 mx-auto max-w-prose text-gray-500">
                  ...
                  basiert die Verarbeitung auf Art. 6 I lit. c DS-GVO. In
                  ...
                  die Verarbeitung auf Art. 6 I lit. d DS-GVO beruhen. Letztlich
                ...
                <p className="mt-5 mx-auto max-w-prose text-gray-500">
                  ...
                  I lit. f DS-GVO ist unser berechtigtes Interesse die
                ...
                <h4 className="mt-5 mx-auto max-w-prose text-xl font-extrabold text-gray-900">
                  9. Dauer, für die die personenbezogenen Daten gespeichert
                  werden
                </h4>
                <p className="mt-5 mx-auto max-w-prose text-gray-500">
                ...
                <p className="mt-10 mx-auto max-w-prose text-xs text-gray-300">
                  Entwickelt von den{" "}
                  <a href="https://willing-able.com/">Legal Tech</a>{" "}
                  Spezialisten von Willing & Able, die auch das System für
                  datenschutzrechtlich durchdachte{" "}
                  <a href="https://abletotrack.com/">
                    online Urlaubs- und Zeiterfassung
                  </a>{" "}
                  entwickelt haben. Die Texte des
                  Datenschutzerklärungs-Generators wurden von{" "}
