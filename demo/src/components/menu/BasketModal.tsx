  ...
  return (
    <div className='container flex flex-col space-y-2 bg-white px-0'>
      <div className="flex flex-row">
        <strong className="grow">Pizza 1 super lange beschreibung mit super viel Text drin</strong>
        ...
        <ModalContent>
          {(onClose) => (
            <>
              ...
              <ModalBody>
                <ScrollShadow className="px-6 flex flex-col space-y-10 min-h-[40vh]">
                  <SingleItemMockup />
                  <SingleItemMockup />
                  <SingleItemMockup />
                  <SingleItemMockup />
              ...
              <ModalFooter>
                <Button
                  radius={'full'}
                  className='text-md bg-black px-8 py-7 font-bold text-white w-full'
                  onClick={() => {
                    onClose();
