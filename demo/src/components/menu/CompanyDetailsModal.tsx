            ...
            <ModalBody>
              ...
              <div className='container flex flex-col space-y-3 bg-white pt-4'>
                ...
                <div className='flex flex-col space-y-0 rounded-lg border border-gray-300 bg-[#f9fafb] p-3 shadow'>
                  ...
                  <span>{companyInformation.location.streetName} {companyInformation.location.streetNumber}</span>
                  <span>{companyInformation.location.postalCode} {companyInformation.location.city}</span>
                </div>
