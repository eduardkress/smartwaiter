...
async function middleware(request) {
    ...
    if (request.nextUrl.pathname == "/pos/dashboard") {
        const token = await (0,jwt.getToken)({
            req: request,
            secret: "33jr9jfH5CLwSqsArC2uugxFXFW7vZhF"
        });
        if (!token) {
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fsrc%2Fmiddleware.ts&page=%2Fsrc%2Fmiddleware&rootDir=%2FUsers%2Frene%2FGit%2Fsmartwaiter%2Fdemo&matchers=&preferredRegion=&middlewareConfig=e30%3D!
...
async function getToken(params) {
    ...
    const { req, secureCookie = (_process$env$NEXTAUTH = (_process$env$NEXTAUTH2 = "https://demo.smartwaiter.app") === null || _process$env$NEXTAUTH2 === void 0 ? void 0 : _process$env$NEXTAUTH2.startsWith("https://")) !== null && _process$env$NEXTAUTH !== void 0 ? _process$env$NEXTAUTH : !!process.env.VERCEL, cookieName = secureCookie ? "__Secure-next-auth.session-token" : "next-auth.session-token", raw, decode: _decode = decode, logger = console, secret = "33jr9jfH5CLwSqsArC2uugxFXFW7vZhF" } = params;
